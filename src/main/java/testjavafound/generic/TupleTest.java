package main.java.testjavafound.generic;//: generics/TupleTest.java

import main.java.testjavafound.net.mindview.util.FiveTuple;
import main.java.testjavafound.net.mindview.util.FourTuple;
import main.java.testjavafound.net.mindview.util.ThreeTuple;
